...
- execução de tarefas terapêuticas
...
| Média       | Interpretação      |
| ----------- | ------------------ |
| 0,00 – 1,49 | Alta aderência     |
| 1,50 – 2,49 | Boa aderência      |
| 2,50 – 3,24 | Aderência limitada |
| 3,25 – 4,00 | Baixa aderência    |
...
| Média       | Interpretação                 |
| ----------- | ----------------------------- |
| 0,00 – 1,49 | Baixo impacto de barreiras    |
...
*Exemplo ilustrativo da evolução dos fatores de aderência ao longo do acompanhamento terapêutico.*
-->
