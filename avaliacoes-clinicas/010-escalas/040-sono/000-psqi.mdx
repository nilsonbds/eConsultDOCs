...
<ScaleDownload
  file="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/scales/PSQI.pdf"
  scale="PSQI"
...
## Acompanhe o PSQI ao longo do tratamento

No eConsult, você pode manter as aplicações do PSQI associadas à pessoa atendida e acompanhar os resultados junto ao histórico clínico.

✓ Pessoa atendida　·　✓ Aplicações e resultados　·　✓ Prontuário　·　✓ Acompanhamento da evolução

![Exemplo de acompanhamento longitudinal do PSQI no eConsult](/img/avaliacoes-clinicas/longitudinalidade/psqi.png)

*Exemplo ilustrativo de acompanhamento longitudinal do PSQI no eConsult. Os dados apresentados são fictícios e foram criados exclusivamente para fins de demonstração. Aplicações sucessivas permitem visualizar a evolução dos escores ao longo do tempo e apoiar a análise clínica do profissional.*
