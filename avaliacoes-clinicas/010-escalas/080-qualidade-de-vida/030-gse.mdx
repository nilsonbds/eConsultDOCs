...
Precisa aplicar o GSE em sua prática clínica?

Você pode baixar gratuitamente a versão em PDF da escala para utilização profissional.

<ScaleDownload
  file="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/scales/GSE.pdf"
  scale="GSE"
  label="Baixar GSE em PDF"
/>
...
## Responda a GSE Online Gratuitamente

Prefere responder o teste em vez de calcular a pontuação manualmente?

Utilize a versão online da **GSE** para obter:
...
👉 [**Responder GSE Online**](https://econsult.app.br/teste-psicologico/gse)

> Ideal para psicólogos, psiquiatras, médicos, estudantes e outros profissionais da saúde que desejam calcular rapidamente a pontuação da **General Self-Efficacy Scale (GSE)**, instrumento utilizado para avaliar a percepção de autoeficácia geral, ou seja, a confiança do indivíduo em sua capacidade de enfrentar desafios, resolver problemas e lidar com situações difíceis do cotidiano.
...
## Acompanhe o GSE ao longo do tratamento

No eConsult, você pode manter as aplicações do GSE associadas à pessoa atendida e acompanhar os resultados junto ao histórico clínico.

✓ Pessoa atendida　·　✓ Aplicações e resultados　·　✓ Prontuário　·　✓ Acompanhamento da evolução

![Exemplo de acompanhamento longitudinal do GSE no eConsult](/img/avaliacoes-clinicas/longitudinalidade/gse.png)

*Exemplo ilustrativo de acompanhamento longitudinal do GSE no eConsult. Os dados apresentados são fictícios e foram criados exclusivamente para fins de demonstração. Aplicações sucessivas permitem visualizar a evolução dos escores ao longo do tempo e apoiar a análise clínica do profissional.*
