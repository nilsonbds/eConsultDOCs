...
<ScaleDownload
  file="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/scales/WHOQOL-BREF.pdf"
  scale="WHOQOL-BREF"
...
## Acompanhe o WHOQOL-BREF ao longo do tratamento

No eConsult, você pode manter as aplicações do WHOQOL-BREF associadas à pessoa atendida e acompanhar os resultados junto ao histórico clínico.

✓ Pessoa atendida　·　✓ Aplicações e resultados　·　✓ Prontuário　·　✓ Acompanhamento da evolução

![Exemplo de acompanhamento longitudinal do WHOQOL-BREF no eConsult](/img/avaliacoes-clinicas/longitudinalidade/whoqol-bref.png)

*Exemplo ilustrativo de acompanhamento longitudinal do WHOQOL-BREF no eConsult. Os dados apresentados são fictícios e foram criados exclusivamente para fins de demonstração. Aplicações sucessivas permitem visualizar a evolução dos escores ao longo do tempo e apoiar a análise clínica do profissional.*
