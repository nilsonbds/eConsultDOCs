...
<ScaleDownload
  file="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/scales/PSWQ.pdf"
  scale="PSWQ"
...
## Acompanhe o PSWQ ao longo do tratamento

No eConsult, você pode manter as aplicações do PSWQ associadas à pessoa atendida e acompanhar os resultados junto ao histórico clínico.

✓ Pessoa atendida　·　✓ Aplicações e resultados　·　✓ Prontuário　·　✓ Acompanhamento da evolução

![Exemplo de acompanhamento longitudinal do PSWQ no eConsult](/img/avaliacoes-clinicas/longitudinalidade/pswq.png)

*Exemplo ilustrativo de acompanhamento longitudinal do PSWQ no eConsult. Os dados apresentados são fictícios e foram criados exclusivamente para fins de demonstração. Aplicações sucessivas permitem visualizar a evolução dos escores ao longo do tempo e apoiar a análise clínica do profissional.*
