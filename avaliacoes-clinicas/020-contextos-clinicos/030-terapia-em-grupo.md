---
sidebar_position: 30
title: Avaliações Psicológicas na Terapia em Grupo
description: "Entenda como utilizar avaliações psicológicas na terapia em grupo para monitorar a evolução dos participantes, acompanhar resultados terapêuticos e apoiar decisões clínicas ao longo do processo."
keywords:
- terapia em grupo
...
# Avaliações Psicológicas na Terapia em Grupo
...
<div style={{
  ...
  <img 
    src="/img/avaliacoes-clinicas/avaliacoes-psicologicas-na-terapia-em-grupo.png" 
    alt="Fluxo de utilização de avaliações psicológicas na terapia em grupo, incluindo caracterização dos participantes, aplicação de avaliações, monitoramento individual e coletivo, leitura evolutiva dos resultados e ajustes terapêuticos." 
    style={{
