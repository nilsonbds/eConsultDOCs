---
sidebar_position: 10
title: Triagem vs Acompanhamento Longitudinal
description: "Entenda as diferenças entre triagem clínica e acompanhamento longitudinal e descubra por que avaliações periódicas podem ampliar a compreensão da evolução clínica ao longo do tempo."
---
...
<div style={{
  ...
  <img 
    src="/img/avaliacoes-clinicas/triagem-vs-acompanhamento-longitudinal.png" 
    alt="Comparação entre triagem clínica e acompanhamento longitudinal, mostrando a diferença entre uma avaliação pontual que fornece uma fotografia do momento atual e um acompanhamento contínuo que permite visualizar tendências, padrões, evolução, estabilidade e mudanças ao longo do tempo." 
    style={{
...
<small>A triagem fornece uma fotografia inicial do caso. O acompanhamento longitudinal permite observar a trajetória clínica ao longo do tempo, identificando tendências, padrões e mudanças que não seriam percebidos em uma única avaliação.</small>
