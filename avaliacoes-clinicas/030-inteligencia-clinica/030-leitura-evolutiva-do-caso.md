---
sidebar_position: 30
title: Leitura Evolutiva do Caso
description: "Entenda como diferentes fontes de informação podem ser analisadas em conjunto para apoiar a compreensão da evolução clínica ao longo do acompanhamento."
---
...
<div style={{
  ...
  <img 
    src="/img/avaliacoes-clinicas/acompanhamento-clinico-longitudinal.webp" 
    alt="Exemplo de visualizações longitudinais do acompanhamento clínico integrando avaliações, marcadores clínicos, síntese evolutiva e indicadores históricos." 
    style={{
      display: "inline-block",
      maxWidth: "none",
      width: "1500px",
