...
## O perigo dos sistemas para psicólogos que  armazenam arquivos
...
> “O eConsult foi concebido para guardar com segurança apenas o que é necessário para o trabalho clínico — e deixar sob controle do psicólogo tudo o que diz respeito ao sigilo e aos arquivos do paciente.”

Por isso, a plataforma adota um modelo híbrido e seguro:
...
- **Os arquivos anexados** (PDFs, imagens, relatórios) são armazenados **diretamente no Google Drive do psicólogo**, por meio de uma integração OAuth segura.
...
- **independência do psicólogo em relação ao sistema** — seus dados permanecem acessíveis e sob seu controle, mesmo fora do eConsult;
