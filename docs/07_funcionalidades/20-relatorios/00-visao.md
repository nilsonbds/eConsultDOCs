...
### Relatórios de Clientes e Grupos de Atendimento
...
:::tip Funcionalidades de Emissão
    ...
    - **Gerar CSV ![Relatórios](../../../static/img/prints/buttons/btn_gerar_csv.png):** Exporta os dados em um arquivo com extensão ``` .csv ```, ideal para análise em planilhas como o Microsoft Excel.

    - **Gerar PDF ![Relatórios](../../../static/img/prints/buttons/btn_gerar_pdf.png):** Gera um arquivo em formato ``` .pdf ```, pronto para impressão ou compartilhamento.
:::