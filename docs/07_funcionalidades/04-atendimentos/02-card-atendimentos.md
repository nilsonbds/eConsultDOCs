...
- **Nome do cliente ou grupo:** Nome do cliente ou grupo terapêutico ao qual o atendimento está relacionado.
...
|Ícone|Indicação|
|-|-|
|![Atendimentos](../../../static/img/prints/buttons/btn_remoto.png)|Podendo ser exibido abaixo do nome do cliente ou grupo terapêutico, indicando que se trata de um atendimento remoto. Se este icone não for mostrado, significa que o atendimento é presencial.|
