...
O eConsult disponibiliza uma ferramenta prática e eficiente para o **registro de pagamentos, presenças e ausências** dos participantes em **grupos de atendimento**, proporcionando um controle detalhado e organizado da participação de cada cliente ao longo das sessões.
...
## Registrar recebimento de um membro do grupo de atendimento

1. Acione a opção ![Atendimento](../../../static/img/prints/atendimento/071.png) no *card* do atendimento desejado.

    ![Atendimento](../../../static/img/prints/atendimento/070.png)

1. O sistema abre a tela "Informe de Presença e Pagamentos".

    ![Atendimento](../../../static/img/prints/atendimento/072.png)

1. Acione a opção "Ver Recebimentos" ![Atendimento](../../../static/img/prints/atendimento/073.png).

1. O sistema abre a tela de pagamentos.

    ![Atendimento](../../../static/img/prints/atendimento/074.png)

1. Acione a opção membros ![Atendimento](../../../static/img/prints/buttons/btn_membros.png).

1. O sistema abre opção para você escolher um dos membros como "Pagador" – escolha um pagador.

    ![Atendimento](../../../static/img/prints/atendimento/075.png)

1. Preencha os campos "Valor", "Data" e "Foma de Pagamento".    

    ![Atendimento](../../../static/img/prints/atendimento/076.png)

1. Acione a opção "Incluir" ![Atendimento](../../../static/img/prints/buttons/btn_incluir.png).

1. O sistema atualiza a tela de pagamento com o registro de recebimento feito.

    ![Atendimento](../../../static/img/prints/atendimento/077.png)
...
1. Feche a tela e, você notará que na tela "Informe de Presença e Pagamentos" a informação de pagamento contará no *card* do membro respectivo.
    ...
    ![Atendimento](../../../static/img/prints/atendimento/078.png)

1. Feche a tela.

1. Repare que o *card* de atendimento passa a mostrar o valor "Pago".

    ![Atendimento](../../../static/img/prints/atendimento/080.png)

1. Acione novamente a opção ![Atendimento](../../../static/img/prints/atendimento/071.png).

1. O sistema abre a tela "Informe de Presença e Pagamentos". Repare que o sistema passa a mostrar a informação "Pago".

    ![Atendimento](../../../static/img/prints/atendimento/081.png)

## Registrar recebimento de alguém de fora do grupo de atendimento
...
1. Preencha o campo "Pagador" com o nome do instituto ou da pessoa física ou jurídica que pagou pelo serviço.
    ...
    ![Atendimento](../../../static/img/prints/atendimento/082.png)

1. Preencha os campos "Valor", "Data" e "Foma de Pagamento".    

    ![Atendimento](../../../static/img/prints/atendimento/083.png)

1. Acione a opção "Incluir" ![Atendimento](../../../static/img/prints/buttons/btn_incluir.png).

1. O sistema atualiza a tela de pagamento com o registro de recebimento feito.

    ![Atendimento](../../../static/img/prints/atendimento/084.png)
...
1. Feche a tela e, você notará que na tela "Informe de Presença e Pagamentos" a informação de pagamento contará em "Outros pagadores".
    ...
    ![Atendimento](../../../static/img/prints/atendimento/085.png)

1. Feche a tela.

1. Repare que o *card* de atendimento passa a mostrar o valor "Pago".

## Registrar presença/ausência dos membros do grupo de atendimento
