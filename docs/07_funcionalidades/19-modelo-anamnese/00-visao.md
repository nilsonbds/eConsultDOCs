...
1. No painel "Modelos de Anamnese" clique no botão "Incluir novo modelo de anamnese" ![Modelo de Anamnese](../../../static/img/prints/buttons/btn_add.png).

1. O sistema abrirá a tela de cadastro pedindo que você selecione uma pré-definição.

    ![Modelos de Anamnese](../../../static/img/prints/anamnese/002.png)

1. Selecione uma das pré-definições disponibilizadas.

    ![Modelos de Anamnese](../../../static/img/prints/anamnese/003.png)
...
1. Dê um nome para o campo.
    ...
    ![Modelos de Anamnese](../../../static/img/prints/anamnese/008.png)
