...
1. Acione a opção **Novo Assistente** ![Painel Conta](../../../static/img/prints/buttons/btn_add.png).

2. Preencha os campos "E-mail" e "Nome".

3. Selecione as permissões que serão dadas ao assistente.

    ![Painel Conta](../../../static/img/prints/06_assistentes-003.png)

4. Clique no botão **Salvar e enviar convite** ![Painel Conta](../../../static/img/prints/buttons/btn_salvar-e-enviar-convite.png).
