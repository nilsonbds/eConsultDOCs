...
<figure style={{ margin: 0, textAlign: "left", marginBottom: "20px" }}>
  <img src="/img/prints/clientegrupo/clientegrupo-003.png" alt="Pacientes e Grupos" />
...
:::note
    Mais informações sobre a Área do Paciente, [clique aqui](/docs/funcionalidades/area-cliente/visao-area-cliente).
:::

## Informações e botões que podem constar nos *cards* de Pacientes e Grupos Terapêuticos

![Painel Pacientes e Grupos](../../../static/img/prints/clientegrupo/clientegrupo-004.png)
