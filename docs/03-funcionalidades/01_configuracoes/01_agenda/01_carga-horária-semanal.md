...
Embora o cadastro da carga horária semanal não seja uma configuração obrigatória, ela é altamente recomendado devido aos significativos benefícios que proporciona. Este cadastro permite um planejamento detalhado dos atendimentos ao longo das semanas, oferecendo uma visão clara e precisa da distribuição dos horários. Com essa visão, você pode alocar o tempo disponível de maneira mais eficiente, evitando conflitos.
...
## Incluir carga horária semanal

1. No painel "Configurações", acione a opção ![Painel Configurações](../../../../static/img/prints//buttons/btn_carga-horaria-semanal.png).

2. O sistema abrirá a tela "Carga Horária Semanal".

3. Acione a opção **Incluir Carga Horária Semanal** ![Painel Configurações](../../../../static/img/prints/buttons/btn_add.png).
...
:::note
- ![Painel Configurações](../../../../static/img/prints/buttons/btn_disponibilidade.png) Indica que o horário está liberabdo para atendimentos.
...
:::tip Outras Opções de Carga Horária
- **Seleção de Dias:** O sistema permite que você selecione e processe um ou mais dias da semana de uma vez. Isso é especialmente útil se você tiver cargas horárias ou intervalos diferentes para cada dia. Por exemplo, se sua carga horária de sexta-feira é diferente da de segunda, você pode configurá-las separadamente.
...
- **Data Início:** A carga horária configurada será aplicada na agenda a partir da data que você inserir no campo "Início". Isso permite que você programe as mudanças com antecedência, controlando quando a nova configuração entrará em vigor.
