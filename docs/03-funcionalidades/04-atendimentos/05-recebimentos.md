...
- **Saldo pendente**
    ...
    - O sistema exibe, no *card* do atendimento, ao lado do valor do atendimento, um indicador visual caso o valor ainda não tenha sido 100% (cem por cento) recebido.
        ...
        ![Atendimento](../../../static/img/prints/atendimento/037.png)
...
1. Acione a opção ![Atendimento](../../../static/img/prints/buttons/btn_card-edit.png) no *card* do atendimento que deseja incluir um recebimento.
...
1. O sistema abre a tela de pagamentos.
    ...
    ![Atendimento](../../../static/img/prints/atendimento/039.png)

1. Preencha o campo "Valor", "Data" e "Forma de Pagamento" e acione o botão "Incluir" ![Atendimento](../../../static/img/prints/buttons/btn_incluir.png).
...
1. Ao fechar esta tela, será exibido no *card* do atendimento as informações de pagamento já atualizadas.
    ...
    ![Atendimento](../../../static/img/prints/atendimento/043.png)
    :::

## Excluir um recebimento:

1. Acione a opção ![Atendimento](../../../static/img/prints/buttons/btn_card-edit.png) no *card* do atendimento que deseja excluir um recebimento.
...
1. O sistema abre a tela de pagamentos.
    ...
    ![Atendimento](../../../static/img/prints/atendimento/040.png)

1. No final da tela de pagamentos o sistema mostra os recebimentos já feitos.

1. Acione o botão ![Atendimento](../../../static/img/prints/buttons/btn_card-delete.png) e confirme a exclusão.
