...
- ![Painel Atendimento](../../../static/img/prints/atendimento/012.png)**Calendário sendo Exibido:** Indica que o painel está exibindo o calendário do mês. Ao selecionar esta opção, o calendário será ocultado e o botão será substituído por ![Painel Atendimento](../../../static/img/prints/atendimento/013.png).

    - *Este botão só será exibido na versão de visão Mobile.*
    
- ![Painel Atendimento](../../../static/img/prints/atendimento/013.png)**Calendário sendo Ocultado:** Indica que o painel está ocultando o calendário do mês. Ao selecionar esta opção, o calendário será exibido e o botão será substituído por ![Painel Atendimento](../../../static/img/prints/atendimento/012.png).
...
- ![Painel Atendimento](../../../static/img/prints/atendimento/016.png)**Semana/Mês Anterior:** Move o calendário para exibir a semana ou o mês anterior.

- ![Painel Atendimento](../../../static/img/prints/atendimento/017.png)**Semana/Mês Posterior:** Move o calendário para exibir a semana ou o mês posterior.# Disponibilidades, Intervalos e Recessos
