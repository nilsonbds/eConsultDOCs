...
![Painel Clientes e Grupos](../../../../static/img/prints/buttons/aba-resultado.png)
...
- **Detalhe da Frequência:** Mostra o comportamento de comparecimento do cliente, permitindo identificar padrões de assiduidade.
    ...
    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-040.png)

- **Inadimplência:** Exibe o percentual de pagamentos em atraso do cliente, facilitando o acompanhamento da saúde financeira.

    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-041.png)

- **Perdas (Baixas Contábeis):** Representa os valores do cliente reconhecidos como perda definitiva no período.

    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-042.png)

- **Perdas Recuperadas:** Indica os valores do cliente previamente perdidos que foram posteriormente recuperados.

    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-043.png)

- **Ocupação:** Mostra a taxa de ocupação do cliente na agenda.

    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-044.png)
...
- **Valor dos Atendimentos:** Detalha os valores financeiros praticados com o cliente relacionados aos atendimentos realizados, permitindo análise de receita.
    ...
    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-045.png)
...
![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-047.png)

**Botões do seletor de período:**
​​    
- ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-048.png) Movimenta o período de amostragem para menos um mês.
​​
- ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-049.png) Movimenta o período de amostragem para mais um mês.
​​
- ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-050.png) Acrescenta um mês ao período de amostragem, sendo que o mês incluído é sempre o que antecede o menor mês do período.
​​
- ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-051.png) Exclui um mês do período de amostragem, sendo que o mês excluído é o menor mês do período.
:::
...
![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-052.png)

Os indicadores estão organizados nos seguintes *cards*:

1. **Dados da Relação com o Cliente**

    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-053.png)
...
1. **Atendimentos do Mês**
    ...
    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-054.png)
...
1. **Inadimplência**
    ...
    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-056.png)

    - Valor inadimplente no mês, no ano e no total.

1. **Perdas (Baixas Contábeis)**

    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-057.png)

    - Valor das perdas geradas pelo cliente no mês, no ano e no total.

1. **Perdas Recuperadas**

    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-058.png)

    - Valor das perdas recuperadas no mês, no ano e no total.

1. **Ocupação da Agenda**

    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-059.png)
...
1. **Custos Pagos**
    ...
    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-060.png)

    - Valor mínimo, médio e máximo pago pelo cliente em atendimentos no mês.

1. **Detalhamento da Frequência**

    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-061.png)
...
1. **Remarcações e Desmarcações**
    ...
    ![Painel Clientes e Grupos](../../../../static/img/prints/clientegrupo/clientegrupo-062.png)
