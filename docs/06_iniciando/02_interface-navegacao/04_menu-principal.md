...
| **Clientes** | Abre o [Painel Clientes](/docs/funcionalidades/clientes-grupos/visao-clientes-grupos) - oferece acesso fácil a dados de clientes e grupos terapêuticos, promovendo controle, produtividade e decisões mais assertivas na gestão destes cadastros.|
...
| **Faturas do cliente** | Abre o [Painel Faturas do Cliente](/docs/funcionalidades/faturas-cliente/visao) - gerencia, visualiza e controla faturas de um cliente ou grupo terapêutico de forma organizada e centralizada.|
