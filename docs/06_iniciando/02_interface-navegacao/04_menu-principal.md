...
| **Pacientes e Grupos Terapêuticos** | Abre o [Painel Pacientes e grupos Terapêuticos](/docs/funcionalidades/clientes-grupos/visao-clientes-grupos) - oferece acesso fácil a dados de clientes e grupos terapêuticos, promovendo controle, produtividade e decisões mais assertivas na gestão destes cadastros.|
