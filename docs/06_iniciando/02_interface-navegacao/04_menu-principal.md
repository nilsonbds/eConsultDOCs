...
O Menu Principal pode ser acessado através do botão ![Botão Tarefas](../../../static/img/prints/buttons/btn_tarefas.png) no menu [Tarefas](/docs/iniciando/interface-navegacao/menu-tarefas).

![Tela: Menu Tarefas](../../../static/img/prints/04_menu-principal-001.png)
...
| **Pacientes** | Abre o [Painel Pacientes](/docs/funcionalidades/clientes-grupos/visao-clientes-grupos) - oferece acesso fácil a dados de clientes e grupos terapêuticos, promovendo controle, produtividade e decisões mais assertivas na gestão destes cadastros.|
...
| **Lembretes de Atendimentos** | Abre o [Painel Lembretes de Atendimentos](/docs/funcionalidades/lembretes/visao) - organiza os atendimentos com características semelhantes, oferecendo foco e clareza no gerenciamento das tarefas.|
...
| **Alertas** | Abre o [Painel Alertas](/docs/funcionalidades/alertas/visao) - destaca ocorrências que exigem atenção, permitindo ação rápida e garantindo uma gestão proativa e eficiente da plataforma eConsult.|
| **Faturas do paciente** | Abre o [Painel Faturas do Paciente](/docs/funcionalidades/faturas-cliente/visao) - gerencia, visualiza e controla faturas de um paciente ou grupo terapêutico de forma organizada e centralizada.|
...
| **Análise de score** | Abre o [Painel Análise de Score](/docs/funcionalidades/analise-score/visao) - exibe o score dos clientes com base no histórico e comportamento, facilitando decisões estratégicas com análises por mês, ano e global.|
| **Campanhas de cashback** | Abre o [Painel Campanhas de Cashback](/docs/funcionalidades/campanha-cashback/visao) - permite criar campanhas de cashback para engajar clientes, recompensar fidelidade e aumentar a continuidade e volume dos atendimentos.|
...
| **Modelos de anamnese** | Abre o [Painel Modelos de Anamnese](/docs/funcionalidades/modelo-anamnese/visao) - permite a gestão de modelos de anamnese personalizados para coletar informações específicas de clientes, facilitando a padronização dos dados usados no prontuário.|
| **Arquivos** | Abre o [Painel Arquivos](/docs/funcionalidades/arquivos/visao) - permite visualizar e anexar arquivos vinculados a clientes, grupos ou atendimentos usando o sistema integrado de gerenciamento de arquivos.|
