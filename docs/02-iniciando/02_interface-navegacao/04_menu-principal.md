...
| **Clientes** | Abre o [Painel Clientes](/docs/funcionalidades/clientes-grupos/visao-clientes-grupos) - oferece acesso fácil a dados de clientes e grupos de atendimento, promovendo controle, produtividade e decisões mais assertivas na gestão destes cadastros.|
...
| **Faturas do cliente** | Abre o [Painel Faturas do Cliente](/docs/funcionalidades/faturas-cliente/visao) - gerencia, visualiza e controla faturas de um cliente ou grupo de atendimento de forma organizada e centralizada.|
