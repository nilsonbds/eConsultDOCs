...
- **Cliente(s) ativo(s) sem e-mail, celular e/ou data de nascimento:** Mostra o número de cadasros de clientes ou grupos de atendimento que não tem e-mails e/ou celular cadastrados.
...
|![Tela: Painel Inicial](../../../static/img/prints/02_painel-inicial-005.png) | Abre o [Painel Lembretes](/docs/funcionalidades/lembretes/visao) |
