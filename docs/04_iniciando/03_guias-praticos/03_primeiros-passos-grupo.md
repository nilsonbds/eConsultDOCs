...
- cadastrar os participantes do grupo
- estruturar o grupo terapêutico
- organizar a agenda
- registrar atendimentos em grupo
- acompanhar evoluções clínicas coletivas e individuais
- iniciar o prontuário do grupo
...
- preservar informações específicas de cada participante
- acompanhar presença, engajamento e evolução individual
- estruturar acompanhamentos clínicos mais completos
- possibilitar futuras integrações clínicas e documentais

##### 🎞️ Vídeo rápido

- cadastrando os participantes do grupo

<video controls preload="metadata" poster="/img/thumbs/video-tutorial.jpg" style={{ borderRadius: '30px', margin: '1.5rem 0', maxHeight: '670px', maxWidth: '100%', border: '1px solid whitesmoke', boxShadow: '0 10px 30px rgba(15, 23, 42, 0.10)', overflow: 'hidden', background: '#fff', cursor: 'pointer' }}>
  <source src="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/videos/grupo/pacientes.mp4" type="video/mp4" />
  Seu navegador não suporta vídeo.
</video>
...
✨ No eConsult, o grupo possui um acompanhamento próprio — permitindo registrar sessões, evoluções, marcadores clínicos e prontuário longitudinal do processo grupal.

Você poderá:

- vincular os participantes do grupo
- definir o contexto do atendimento
- estruturar o acompanhamento coletivo
- registrar objetivos terapêuticos do grupo
- iniciar a trajetória clínica grupal
...
<video controls preload="metadata" poster="/img/thumbs/video-tutorial.jpg" style={{ borderRadius: '30px', margin: '1.5rem 0', maxHeight: '670px', maxWidth: '100%', border: '1px solid whitesmoke', boxShadow: '0 10px 30px rgba(15, 23, 42, 0.10)', overflow: 'hidden', background: '#fff', cursor: 'pointer' }}>
  <source src="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/videos/grupo/grupo-terapeutico.mp4" type="video/mp4" />
  Seu navegador não suporta vídeo.
</video>
...
<video controls preload="metadata" poster="/img/thumbs/video-tutorial.jpg" style={{ borderRadius: '30px', margin: '1.5rem 0', maxHeight: '670px', maxWidth: '100%', border: '1px solid whitesmoke', boxShadow: '0 10px 30px rgba(15, 23, 42, 0.10)', overflow: 'hidden', background: '#fff', cursor: 'pointer' }}>
  <source src="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/videos/grupo/agendamento-de-multiplos-atendimentos.mp4" type="video/mp4" />
  Seu navegador não suporta vídeo.
</video>
...
- pagamentos
- registros pendentes
- grupos sem novo agendamento
- tarefas clínicas importantes
- pendências relacionadas aos participantes do grupo
...
<video controls preload="metadata" poster="/img/thumbs/video-tutorial.jpg" style={{ borderRadius: '30px', margin: '1.5rem 0', maxHeight: '670px', maxWidth: '100%', border: '1px solid whitesmoke', boxShadow: '0 10px 30px rgba(15, 23, 42, 0.10)', overflow: 'hidden', background: '#fff', cursor: 'pointer' }}>
  <source src="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/videos/grupo/situacoes-de-atendimento-clinico.mp4" type="video/mp4" />
  Seu navegador não suporta vídeo.
</video>
...
- alianças, tensões e padrões relacionais
- evolução terapêutica do grupo
- prioridades clínicas
- momentos de crise, reorganização ou estabilização

✨ O eConsult permite estruturar tanto a percepção clínica do grupo quanto observações relacionadas aos participantes individualmente.
...
<video controls preload="metadata" poster="/img/thumbs/video-tutorial.jpg" style={{ borderRadius: '30px', margin: '1.5rem 0', maxHeight: '670px', maxWidth: '100%', border: '1px solid whitesmoke', boxShadow: '0 10px 30px rgba(15, 23, 42, 0.10)', overflow: 'hidden', background: '#fff', cursor: 'pointer' }}>
  <source src="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/videos/grupo/anotacoes-clinicas-com-marcadores-clinicos.mp4" type="video/mp4" />
  Seu navegador não suporta vídeo.
</video>
...
<video controls preload="metadata" poster="/img/thumbs/video-tutorial.jpg" style={{ borderRadius: '30px', margin: '1.5rem 0', maxHeight: '670px', maxWidth: '100%', border: '1px solid whitesmoke', boxShadow: '0 10px 30px rgba(15, 23, 42, 0.10)', overflow: 'hidden', background: '#fff', cursor: 'pointer' }}>
  <source src="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/videos/grupo/resultados.mp4" type="video/mp4" />
  Seu navegador não suporta vídeo.
</video>
...
- mudanças na dinâmica grupal
- evolução da coesão do grupo
...
- leitura clínica integrada do processo grupal

##### 🎞️ Vídeo rápido

- acompanhando evolução longitudinal do grupo terapêutico

<video controls preload="metadata" poster="/img/thumbs/video-tutorial.jpg" style={{ borderRadius: '30px', margin: '1.5rem 0', maxHeight: '670px', maxWidth: '100%', border: '1px solid whitesmoke', boxShadow: '0 10px 30px rgba(15, 23, 42, 0.10)', overflow: 'hidden', background: '#fff', cursor: 'pointer' }}>
  <source src="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/videos/grupo/acompanhamento-clinico-longitudinal.mp4" type="video/mp4" />
  Seu navegador não suporta vídeo.
</video>
...
- acompanhar o processo terapêutico grupal
- preservar registros relevantes dos participantes envolvidos

##### 🎞️ Vídeo rápido

- registrando SOAP
- explorando prontuário do grupo

<video controls preload="metadata" poster="/img/thumbs/video-tutorial.jpg" style={{ borderRadius: '30px', margin: '1.5rem 0', maxHeight: '670px', maxWidth: '100%', border: '1px solid whitesmoke', boxShadow: '0 10px 30px rgba(15, 23, 42, 0.10)', overflow: 'hidden', background: '#fff', cursor: 'pointer' }}>
  <source src="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/videos/grupo/prontuario-eletronico.mp4" type="video/mp4" />
  Seu navegador não suporta vídeo.
</video>
...
<video controls preload="metadata" poster="/img/thumbs/video-tutorial.jpg" style={{ borderRadius: '30px', margin: '1.5rem 0', maxHeight: '670px', maxWidth: '100%', border: '1px solid whitesmoke', boxShadow: '0 10px 30px rgba(15, 23, 42, 0.10)', overflow: 'hidden', background: '#fff', cursor: 'pointer' }}>
  <source src="https://pub-ff830c3079564210a0ad51dbbcb377e3.r2.dev/videos/grupo/prontuario-finalizado.mp4" type="video/mp4" />
  Seu navegador não suporta vídeo.
</video>
...
✔ acompanhar a evolução clínica do grupo  
