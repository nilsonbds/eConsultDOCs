...
# Organize a agenda do mês para o casal

📅 Organize sua agenda para estruturar sua rotina de atendimentos.

> 💡 Com poucos cliques, você consegue agendar várias sessões de um casal de uma só vez.
...
Agora que você já cadastrou o casal, o próximo passo é simples:
...
3. No campo **Paciente/Casal/Família/Grupo**, selecione o paciente desejado
...
👉 [Acompanhe sua rotina](./05_situacoes-de-atendimento-clinico.md)
