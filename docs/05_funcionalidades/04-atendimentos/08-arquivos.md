...
1. Acione a opção ![Atendimento](../../../static/img/prints/buttons/btn-anexos.png) no *card* do atendimento que deseja incluir um arquivo.

1. O sistema abre a tela "Arquivos Anexados ao Atendimento".

    ![Atendimento](../../../static/img/prints/atendimento/060.png)
...
1. O sistema abre o formulário "Arquivos Anexados ao Atendimento".
    ...
    ![Atendimento](../../../static/img/prints/atendimento/061.png)
...
- Os botões "Alterar" ![Atendimento](../../../static/img/prints/buttons/btn_card-edit.png) e "Excluir" ![Atendimento](../../../static/img/prints/buttons/btn_card-delete.png) permitem modificar ou remover arquivos conforme necessário. Já a opção "Visualizar" ![Atendimento](../../../static/img/prints/buttons/btn_visualizar.png) possibilita examinar o conteúdo dos arquivos diretamente, facilitando a consulta e download dos documentos vinculados ao atendimento.
:::
...
#### 🎬 *Anexando um arquivo em um atendimento*

<video
  src="https://econsultapp.com/videos/atendimentos/anexando-um-arquivo-em-um-atendimento.mp4"
  height="auto"
  controls
  preload="metadata"
  style={{
...
<p style={{ color: '#666', fontSize: '0.9rem' }}>
  Neste vídeo, é possível acompanhar a anexação de um arquivo em um atendimento.
</p>