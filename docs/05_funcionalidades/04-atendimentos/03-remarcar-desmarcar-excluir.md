...
No eConsult, existem funcionalidades específicas que permitem a desmarcação, remarcação e exclusão de agendamentos de atendimentos, garantindo maior flexibilidade e organização tanto para as pessoas atendidas quanto para o profissional.

## Desmarcação de Atendimento

A desmarcação de um agendamento de atendimento no eConsult é uma funcionalidade que permite cancelar um atendimento previamente agendado. Essa opção é importante para evitar que horários sejam ocupados desnecessariamente por atendimentos que não serão realizadas, permitindo que outras pessoas atendidas possam utilizar esse tempo. Ao desmarcar um atendimento, a plataforma registra esta desmarcação no cadastro da pessoa atendida como histórico.

### Desmarcar um atendimento

1. Acione a opção ![Atendimento](../../../static/img/prints/buttons/btn_card-edit.png) no *card* do atendimento que deseja desmarcar.

1. O sistema abre a tela que permite a desmarcação.

  ![Atendimento](../../../static/img/prints/atendimento/024.png)

1. Acione a opção "Desmarcar" ![Atendimento](../../../static/img/prints/buttons/btn_desmarcar.png).

1. O sistema apresenta a mensagem de confirmação.

  ![Atendimento](../../../static/img/prints/atendimento/025.png)

1. Acione a opção "Sim" ![Atendimento](../../../static/img/prints/buttons/btn_sim.png).

## Remarcação de Atendimento

A remarcação de um agendamento de atendimento no eConsult permite  a alteração da data e/ou horário de um atendimento previamente marcada. Essa funcionalidade é essencial para situações em que se precisa ajustar o atendimento devido a imprevistos ou mudanças na agenda. A remarcação facilita o processo, evitando a necessidade de desmarcar o agendamento e criar um novo, o que poderia ser mais demorado e confuso. Ao fazer uma remarcação, a plataforma registra esta informação no cadastro da pessoa atendida como histórico.

### Remarcar um atendimento

1. Acione a opção ![Atendimento](../../../static/img/prints/buttons/btn_card-edit.png) no *card* do atendimento que deseja remarcar.

1. O sistema abre a tela que permite a remarcação.

    ![Atendimento](../../../static/img/prints/atendimento/024.png)

1. Acione a opção "Remarcar" ![Atendimento](../../../static/img/prints/buttons/btn_remarcar.png).

1. O sistema apresenta a tela de remarcação.

    ![Atendimento](../../../static/img/prints/atendimento/026.png)
...
1. Acione a opção "Ver disponibilidade" ![Atendimento](../../../static/img/prints/buttons/btn_ver-disponibilidades.png).

1. O sistema abre tela mostrando que o dia/horário indicado está disponível.

    ![Atendimento](../../../static/img/prints/atendimento/029.png)

1. Acione o botão "Remarcar" ![Atendimento](../../../static/img/prints/buttons/btn_remarcar.png).
    ...
    - Em dias úteis, ou seja, sem recesso ou feriado, o sistema marcará automaticamente esses dias com um check. No entanto, você tem a opção de desmarcar essa seleção, caso prefira.
      ...
      ![Atendimento](../../../static/img/prints/atendimento/030.png)
...
1. Acione a opção ![Atendimento](../../../static/img/prints/buttons/btn_card-edit.png) no *card* do atendimento que deseja excluir.

1. O sistema abre a tela que permite a exclusão.

    ![Atendimento](../../../static/img/prints/atendimento/024.png)

1. Acione a opção "Excluir" ![Atendimento](../../../static/img/prints/buttons/btn_excluir.png).

1. O sistema apresenta a mensagem de confirmação.

    ![Atendimento](../../../static/img/prints/atendimento/028.png)
