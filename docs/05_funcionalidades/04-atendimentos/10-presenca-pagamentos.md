...
O eConsult disponibiliza uma ferramenta prática e eficiente para o **registro de pagamentos, presenças e ausências** dos participantes em **grupos terapêuticos**, proporcionando um controle detalhado e organizado da participação de cada membro ao longo das sessões.
...
1. Acione a opção "Recebimentos".

    ![Atendimento](../../../static/img/prints/atendimento/073.png)
...
1. Acione a opção "Receber".

    ![Atendimento](../../../static/img/prints/atendimento/125.png)
...
1. Repare que o *card* do atendimento passa a mostrar o valor "Pago".
...
1. Acione as opções "Compareceu" ou "Não Compareceu" para cada membro.
