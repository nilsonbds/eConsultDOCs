...
1.  Acione a opção ![Atendimento](../../../static/img/prints/atendimento/069.png) no _card_ do atendimento que deseja atribuir lembrete.
...
1. Acione a opção ![Atendimento](../../../static/img/prints/buttons/btn-anotacoes.png) no _card_ do atendimento para o qual deseja incluir uma anotação.
...
1. Selecione no campo "Formato da anotação" a opção "🧠 Obter de Marcadores Clínicos".
   ...
   ![Atendimento](../../../static/img/prints/atendimento/117.png)
...
1. O sistema abrirá a tela de geração de anotação com IA já com a sugestão de anotação.
   ...
   ![Atendimento](../../../static/img/prints/atendimento/123.png)
...
1. O sistema atualizará a tela "Anotações Clínicas" com a nova anotação.
   ...
   ![Atendimento](../../../static/img/prints/atendimento/124.png)

1. Ao fechar esta tela, o sistema atualiza o _card_ do atendimento, indicando que há uma anotação registrada ![Atendimento](../../../static/img/prints/atendimento/051.png) para o atendimento em questão.
