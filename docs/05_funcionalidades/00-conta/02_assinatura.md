...
![Painel Conta](../../../static/img/prints/02_assinatura-001.png)
...
1. Acione a opção ALTERAR em ![Painel Conta](../../../static/img/prints/buttons/alterar_plano_assinatura.png).
...
4. O sistema mostra tela de confirmação informando o que você está alterando.
    ...
    ![Painel Conta](../../../static/img/prints/02_assinatura-004.png)

5. Clique na opção "Confirmar" ![Painel Conta](../../../static/img/prints/buttons/btn_confirmar.png).

6. O sistema abrirá tela de pagamento (PIX).

    ![Painel Conta](../../../static/img/prints/02_assinatura-005.png)
