...
- **Detalhe da Frequência:** Mostra o comportamento de comparecimento das pessoas atendidas, permitindo identificar padrões de assiduidade.
...
- **Desmarcações e Remarcações:** Permite visualizar tendências de cancelamentos e reagendamentos, auxiliando na análise de aderência das pessoas atendidas aos atendimentos e na gestão da agenda.
