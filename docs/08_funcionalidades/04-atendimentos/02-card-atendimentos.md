...
|![Atendimentos](../../../static/img/prints/clientegrupo/clientegrupo-077.png)|**Ocorrências:** Abre a **tela de ocorrências**, onde o profissional pode visualizar os registros e tomar as providências necessárias.|