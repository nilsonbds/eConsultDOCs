...
1. Acione a opção ![Atendimento](../../../static/img/prints/buttons/btn_card-edit.png) no *card* do atendimento que deseja o teleatendimento.
...
1. O sistema fechará a tela e mostrará em azul vivo a opção "Teleatendimento" ![Tela da sala de teleatendimento](../../../static/img/prints/teleatendimento/001.png).
