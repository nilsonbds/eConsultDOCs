...
1. O sistema atualizará a tela "Anotações Clínicas" com a nova anotação.
    ...
    ![Atendimento](../../../static/img/prints/atendimento/105.png)
...
1. Altere o campo "Formato da anotação" para uma das opções:
    ...
    ![Atendimento](../../../static/img/prints/atendimento/106.png)
...
1. Preencha o campo base correspondente para que a IA possa gerar uma sugestão.
    ...
    ![Atendimento](../../../static/img/prints/atendimento/108.png)

1. Acione o botão "Gerar", "Melhorar" ou "Detalhar".

    ![Atendimento](../../../static/img/prints/atendimento/109.png)

1. O sistema preencherá o campo de anotação com uma sugestão da IA.

    ![Atendimento](../../../static/img/prints/atendimento/110.png)
...
1. O sistema atualizará a tela "Anotações Clínicas" com a nova anotação.
    ...
    ![Atendimento](../../../static/img/prints/atendimento/112.png)
...
Na tela de IA, você pode utilizar os botões "Gerar novo", "Melhorar texto", "Detalhar mais" ou "Continuar com IA".
    ...
    ![Atendimento](../../../static/img/prints/atendimento/113.png)

Para saber o que cada um desses botões faz, basta acionar a opção "info ![Atendimento](../../../static/img/prints/atendimento/114.png)", que o sistema abrirá a tela explicativa.

    ![Atendimento](../../../static/img/prints/atendimento/115.png)
