...
5. Acione o botão "Incluir" ![Painel Configurações](../../../../static/img/prints/buttons/btn_incluir.png).
...
2. Acione o botão ![Painel Configurações](../../../../static/img/prints/buttons/btn_card-edit.png) no *card* do recesso que se quer alterar.

3. O sistema abrirá o formulário de cadastro de alteração de recesso.

    ![Painel Configurações](../../../../static/img/prints/02_recessos-004.png)

4. Altere os campos "Número de dias", "Data início", "Data fim" e "Descrição".

5. Acione o botão "Salvar" ![Painel Configurações](../../../../static/img/prints/buttons/btn_salvar.png).
...
2. Acione o botão ![Painel Configurações](../../../../static/img/prints/buttons/btn_card-delete.png) no *card* do recesso que se quer excluir.
