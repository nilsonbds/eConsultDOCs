...
2. Clique em **Enviar link para Área do Paciente** ![Botão enviar link](../../../../static/img/prints/buttons/btn_enviar-link-para-area-do-cliente-wat-ema.png).  
...
- Clicar em **Abrir Área do Paciente** ![Abrir Área](../../../../static/img/prints/buttons/area_do_cliente.png) para visualizar o ambiente;  
- Reenviar o link via o grupo de botões ![Enviar novamente](../../../../static/img/prints/buttons/enviar_link_area_do_cliente.png).
