...
Mesmo profissionais com uma carga de atendimentos adequada podem experimentar sensação de sobrecarga quando a agenda está mal distribuída.
...
### Agrupamento em blocos de atendimento

Sempre que possível, pode ser útil concentrar atendimentos em blocos.
...
- diminuir sensação de agenda “quebrada”  

---

### Evitar concentração excessiva em poucos dias

Embora algumas agendas naturalmente concentrem mais atendimentos em determinados períodos, excesso de concentração pode gerar:

- fadiga intensa em dias específicos  
- queda de energia nas últimas sessões  
- menor margem para imprevistos  
- recuperação insuficiente entre blocos intensos  

---

### Reservar períodos sem atendimento

Nem toda hora útil precisa ser convertida em sessão.

Reservar períodos para:
...
- falta tempo para registros e organização  
- sensação frequente de “sobreviver à semana”  
- dificuldade de encaixar novos pacientes sem desorganizar toda a rotina  
